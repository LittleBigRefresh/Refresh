...
public class SerializedCategory
{
        ...
        int count = 20)
    {
        ...
        DatabaseList<GameLevel> categoryLevels = levelCategory.Fetch(context, skip, count, matchService, database, user, token.TokenGame, new LevelFilterSettings(context));
