...
public class RelationEndpoints : EndpointGroup
{
    ...
    public SerializedFavouriteUserList? GetFavouriteUsers(RequestContext context, IGameDatabaseContext database, string username, Token token, IDataStore dataStore)
    {
