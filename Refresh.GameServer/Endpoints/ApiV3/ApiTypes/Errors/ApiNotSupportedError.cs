...
public class ApiNotSupportedError : ApiError
{
    ...
    public static readonly ApiValidationError OAuthProviderTokenRevocationUnsupportedError = new(OAuthProviderTokenRevocationUnsupportedErrorWhen);

    public const string OAuthProviderDisabledErrorWhen = "The server does not have this OAuth provider enabled";
    public static readonly ApiValidationError OAuthProviderDisabledError = new(OAuthProviderDisabledErrorWhen);
