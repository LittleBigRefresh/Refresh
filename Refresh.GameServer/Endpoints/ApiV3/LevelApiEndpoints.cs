...
public class LevelApiEndpoints : EndpointGroup
{
    ...
    public ApiListResponse<ApiLevelCategoryResponse> GetCategories(RequestContext context, CategoryService categories, MatchService matchService, IGameDatabaseContext database, GameUser? user, IDataStore dataStore)
    {
    ...
    [DocUsesPageData]
    public ApiListResponse<ApiGameLevelResponse> GetLevels(RequestContext context, IGameDatabaseContext database, MatchService matchService, CategoryService categories, GameUser? user, IDataStore dataStore,
    ...
    public ApiResponse<ApiGameLevelResponse> GetLevelById(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
    ...
    public ApiResponse<ApiGameLevelResponse> EditLevelById(RequestContext context, IGameDatabaseContext database, GameUser user, IDataStore dataStore,
