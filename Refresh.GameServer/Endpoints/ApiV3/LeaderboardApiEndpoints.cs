...
public class LeaderboardApiEndpoints : EndpointGroup
{
    ...
    public ApiListResponse<ApiGameScoreResponse> GetTopScoresForLevel(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
    ...
    public ApiResponse<ApiGameScoreResponse> GetScoreByUuid(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
