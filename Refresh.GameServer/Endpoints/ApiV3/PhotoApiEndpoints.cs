...
public class PhotoApiEndpoints : EndpointGroup
{
    ...
    private static ApiListResponse<ApiGamePhotoResponse> PhotosByUser(RequestContext context, IGameDatabaseContext database, GameUser? user, IDataStore dataStore)
    {
    ...
    private static ApiListResponse<ApiGamePhotoResponse> PhotosWithUser(RequestContext context, IGameDatabaseContext database, GameUser? user, IDataStore dataStore)
    {
        if (user == null) return ApiNotFoundError.Instance;
        (int skip, int count) = context.GetPageData(true);
    ...
    private static ApiListResponse<ApiGamePhotoResponse> PhotosInLevel(RequestContext context, IGameDatabaseContext database, GameLevel? level, IDataStore dataStore)
    {
    ...
    public ApiListResponse<ApiGamePhotoResponse> PhotosByUsername(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
    ...
    [DocError(typeof(ApiNotFoundError), "The user cannot be found")]
    public ApiListResponse<ApiGamePhotoResponse> PhotosWithUsername(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
        [DocSummary("The username of the user")] string username)
    ...
    [DocError(typeof(ApiNotFoundError), "The user cannot be found")]
    public ApiListResponse<ApiGamePhotoResponse> PhotosByUserUuid(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
    ...
    [DocError(typeof(ApiNotFoundError), "The user cannot be found")]
    public ApiListResponse<ApiGamePhotoResponse> PhotosWithUserUuid(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
        [DocSummary("The UUID of the user")] string uuid)
    ...
    public ApiListResponse<ApiGamePhotoResponse> PhotosInLevelById(RequestContext context, IGameDatabaseContext database, IDataStore dataStore,
    ...
    public ApiListResponse<ApiGamePhotoResponse> RecentPhotos(RequestContext context, IGameDatabaseContext database, IDataStore dataStore)
    {
        (int skip, int count) = context.GetPageData(true);
    ...
    public ApiResponse<ApiGamePhotoResponse> PhotoById(RequestContext context, IGameDatabaseContext database, IDataStore dataStore, [DocSummary("The ID of the photo")] int id)
    {
        GamePhoto? photo = database.GetPhotoById(id);
