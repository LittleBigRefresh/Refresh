...
public class QueueTests : GameServerTest
{
    ...
    public void QueueAndUnqueueLevel()
    {
        ...
        Assert.That(context.Database.GetLevelsQueuedByUser(user, 1, 0, new ResultFilterSettings(TokenGame.LittleBigPlanet2), user)
    ...
    public void ClearQueue()
    {
        ...
        DatabaseList<GameLevel> queue = context.Database.GetLevelsQueuedByUser(user, 2, 0,
            new ResultFilterSettings(TokenGame.LittleBigPlanet2), user);
